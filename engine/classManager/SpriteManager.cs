...
public static class SpriteManager
{
    ...
    public static void init()
    {
        ...
        s.addSpriteType(SpriteType.MiniMapUI_RoomSetCardEdition, new Vector(450, 0), new Vector(16, 16));
        ...
        s.addSpriteType(SpriteType.Character_LunAlly, new Vector(128, 384), new Vector(126, 126));
        s.addSpriteType(SpriteType.Character_Chlow, new Vector(256, 384), new Vector(126, 126));
        ...
        s.addSpriteType(SpriteType.Cel_SetCardEdition, new Vector(384, 384), new Vector(126, 126));
