...
public class CharacterKingSlime : CharacterMob
{
    ...
    {
        // effects.
        this.AddStatusEffect(new ShildMultBoostColor(this.idEntity, -1, -1, CardColor.Blue, 0f));
        this.AddStatusEffect(new DamageAddByTurn(this.idEntity, -1, -1, CardColor.Blue, 1, 3));
    }
}