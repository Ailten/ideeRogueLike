...
public class CharacterBabulle : CharacterPlayer
{
    public CharacterBabulle(Vector posIndexCel) : base(SpriteType.Character_Babulle, posIndexCel)
    {
        this.MPmax = 3;
        this.MP = MPmax;
        this.APmax = 3;
        ...
        this.deck.addCardToDeck(
            new Card(
                ...
                APCost: 1,
                distanceToUse: new(1, 1),
                effect: new KeyValuePair<EffectCard, int>(EffectCard.Push, 2)
            ),
            amountOfCardAdd: 2,
            isSameColor: false
        );
